...
Maintain `.claude/skills/wispr-corrections.md` - the dictation correction dictionary used by braindump-router.
...
# Check Section 9 size in wispr-corrections.md
grep -c "^- 20" .claude/skills/wispr-corrections.md
```
