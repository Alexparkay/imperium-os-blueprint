...
4. **Infer the problem - and label it as inference.** From the offer (`context/offers.md`) and the evidence: what is this company probably struggling with that the owner solves? Every inference cites its evidence ("hiring three ops roles → scaling pains in delivery"). Facts and inferences NEVER mix unlabelled.
